    ...
    <div className='page'>
      ...
      <h2>Experiencia</h2>
        <ul>
          <li>Durante mis prácticas profesionales en la empresa privada Silver Quality System, 
            ...
            intensivo de herramientas de Python para llevar a cabo minería de datos, un proceso 
            crucial para extraer información valiosa y patrones significativos a partir de grandes 
            volúmenes de datos. Además, implementé y gestioné la transmisión de información 
            mediante el uso de lambdas y endpoints, asegurando así que los datos llegaran de 
            manera eficiente y segura a los diferentes sistemas y aplicaciones utilizados por 
            la empresa. Estas tareas no solo contribuyeron al cumplimiento de los objetivos 
      ...
      <h2>Educacion</h2>
        <ul>
          ...
          <li>2020-2024</li>
          <li>Instalacion y manipulacion de sistemas operativos windows y linux.</li>
          <li>Profundizacion en lenguaje de programacion JAVA.</li>
      ...
      <h2>Reconocimientos</h2>
        <ul>
          ...
          <li>Reconimiento por ser Auxiliar Trainner en el curso demo de PSP.</li>
